...
d_min = None
  .type = float
  .help = "High resolution cutoff for spotfinding and integration."
  .expert_level=1
d_max = None
  .type = float
  .help = "Low resolution cutoff for spotfinding and integration."
  .expert_level=1
batch_size = 1000
  .type = int
...
integration {
  algorithm = stills *ellipsoid
    .type = choice
    .expert_level=2
  ellipsoid.rlp_mosaicity = simple1 *simple6 simple1angular1 simple1angular3 simple6angular1
    .type = choice
    .expert_level=3
  phil = None
    .type = path
