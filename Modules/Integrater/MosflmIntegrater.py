...
def MosflmIntegrater(DriverType = None):
  '''A factory for MosflmIntegrater classes.'''

  DriverInstance = DriverFactory.Driver(DriverType)
  CCP4DriverInstance = DecoratorFactory.Decorate(DriverInstance, 'ccp4')

  class MosflmIntegraterWrapper(CCP4DriverInstance.__class__,
                                FrameProcessor,
                                Integrater):
  ...
  return MosflmIntegraterWrapper()
