...
class DocElement:
    ...
    def render(self):
        ...
        open_div = "<div"
        if self.id():
            open_div += " id='" + str(self.id()) + "'"
        if self.__classes:
            open_div += " class='" + str(self.__classes) + "'"
        open_div += ">"
        close_div = "</div>\n"
...
class Anchor:
    ...
    def embed(self, text=""):
        ...
        return (
            "<a name='" + self.id() + "' id='" + self.id() + "'>" + str(text) + "</a>"
        )
    ...
    def render(self):
        ...
        if self.__inline == LINK:
            ...
            try:
                ...
                text = (
                    "<!-- Failed to inline external file " + self.__filename + "-->\n"
                )
            return text
...
class Stylesheet(ExternalFile):
    ...
    def __init__(self, stylesheet, inline):
        ...
        self.inline_end = "-->\n</style>"
        self.link_format = '<link rel="stylesheet" type="text/css" href="%s" />'
