...
def exercise_xds_integrater(regression_data, tmp_dir, nproc=None):
  if nproc:
...
@pytest.mark.slow
def test_xds_integrater_serial(ccp4, regression_data, run_in_tmpdir):
  with mock.patch.object(sys, 'argv', []):
    exercise_xds_integrater(regression_data, run_in_tmpdir.strpath, nproc=1)
