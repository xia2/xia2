...
# plan for moving to dxtbx / cctbx objects
#
# - replace internal representation
# - map API but keep API
# - add dxtbx API
#
# - then -
#
# - get everything else using dxtbx API: Integrater and Indexer interfaces
# - remove old API: for example any mention of beam centres should go.
...
class XSweep():
  ...
  def __init__(self, name,
    ...
    directory = FileHandler.migrate(expand_path(directory))

    # FIXME at this stage in the constructor create a cctbx/dxtbx sweep
    # object from the image headers, then overwrite any of the parameters
    # correctly from this user input: then *DO NOT* use any of these internal
    # parameters
    ...
    # these should be cctbx objects
    self._user_lattice = user_lattice
    self._user_cell = user_cell

    # everything below here should be through dxtbx models
    ...
    # these are junk and I don't think are used
    self._ice = ice
    ...
    # + derive template, list of images - this will come from dxtbx
