...
\begin{frame}
\frametitle{Sorry...}
\uncover<1-2>{\includegraphics[scale=0.1]{figures/keyboard.jpg}}
\uncover<2-2>{\includegraphics[scale=0.15]{figures/terminal.png}}
\uncover<3->{\includegraphics[scale=0.15]{figures/mouse.jpg}}
\end{frame}
...
\begin{frame}
\frametitle{Where's the documentation?}
\includegraphics[scale=0.33]{figures/xia2-in-a-nutshell.jpg}
\end{frame}
