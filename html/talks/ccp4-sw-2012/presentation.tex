...
{ \huge
xia2 -3da\footnote{-3d, but using AIMLESS to merge, development option}
 -atom Ba /dls/i02/data/...
}
\end{frame}
...
\item{-spacegroup spacegroup\_name - set the spacegroup name, e.g. P21}
