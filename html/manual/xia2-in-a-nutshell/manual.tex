...
\begin{itemize}
\item{-atom X - tell \emph{xia2} to separate anomalous pairs i.e. $I(+) \ne I(-)$ in 
scaling}
\item{-2d - tell \emph{xia2} to use MOSFLM and SCALA}
\item{-3d - tell \emph{xia2} to use XDS and XSCALE}
\item{-3dii - tell \emph{xia2} to use XDS and XSCALE, indexing with
...
\item{Download XDS from http://http://xds.mpimf-heidelberg.mpg.de/ and
