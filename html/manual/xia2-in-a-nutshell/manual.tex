...
\else
  \includegraphics[scale=0.25, bb=0 0 1212 1524]{figures/3qrn-all-rmerge-aimless.png} & 
  \includegraphics[scale=0.25, bb=0 0 1212 1524]{figures/3qrn-all-complete-aimless.png} \\
\fi
\end{tabular}
\end{figure}
...
\else
  \includegraphics[scale=0.25, bb=0 0 1780 1774]{figures/xia2html.png}
\fi
\end{center}
\end{figure}
